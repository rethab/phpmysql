...
class IssueController extends Controller
{
     ...
     * @paraminteger projectId the primary identifier of the associated Project
    ...
    {
        $dataProvider=new CActiveDataProvider('Issue', array('criteria'=>array('condition'=>'project_id=:projectId', 'params'=>array(':projectId'=>$this->_project->id))));
